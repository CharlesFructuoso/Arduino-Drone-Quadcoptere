...
String NomduReseauWifi = "TEST"; // Garder les guillements
String MotDePasse      = "0000000000"; // Garder les guillements 
...
void setup()
{
  ...
  sendCommand("AT+CWSAP=\""+ NomduReseauWifi + "\",\"" + MotDePasse +"\",5,2\r\n",3000,DEBUG);
  delay(10000);
