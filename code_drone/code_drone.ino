...
void setup(){
  ...
  DDRE |= B00101000;                                                        //Configure digital poort 3, 4, 5 and 6 as output.
  DDRH |= B00001000;
  DDRG |= B00100000;
  DDRB |= B00000011;                                                        //Configure digital poort 52 and 53 as output.
  ...
  for (cal_int = 0; cal_int < 1250 ; cal_int ++){                           //Wait 5 seconds before continuing.
    PORTE |= B00101000;                                                     //Set digital poort 3, 4, 5 and 6 high.
    PORTH |= B00001000;
    PORTG |= B00100000;
    delayMicroseconds(1000);                                                //Wait 1000us.
    PORTE &= B11010111;                                                     //Set digital poort 3, 4, 5 and 6 low.
    PORTH &= B11110111;
    PORTG &= B11011111;
  ...
  while(receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1020 || receiver_input_channel_4 < 1400){
    ...
    PORTE |= B00101000;
    PORTH |= B00001000;
    PORTG |= B00100000;                                                     //Set digital poort 3, 4, 5 and 6 high.
    delayMicroseconds(1000);                                                //Wait 1000us.
    PORTE &= B11010111;
    PORTH &= B11110111;
    PORTG &= B11011111;                                                     //Set digital poort 3, 4, 5 and 6 low.
    delay(3);                                                               //Wait 3 milliseconds before the next loop.
...
//  //The refresh rate is 250Hz. That means the esc's need there pulse every 4ms.
  ...
  while(PORTE >= 8 || PORTG >= 32 || PORTH >= 8){                           //Set digital poort 3, 4, 5 and 6 are low.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//This routine is called every time input 10, 11, 12 or 13 changed state. This is used to read the receiver signals. 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ISR(PCINT0_vect){
  current_time = micros();
  //Channel 1=========================================
