...
float roll_pid_d=0;
///////////////////////////////ROLL PID CONSTANTS////////////////////
double roll_kp=0.9;//3.55
double roll_ki=0.001;//0.003
double roll_kd=0.3;//2.05
...
float pitch_pid_d=0;
///////////////////////////////PITCH PID CONSTANTS///////////////////
double pitch_kp=0.9;//3.55
double pitch_ki=0.001;//0.003
double pitch_kd=0.3;//2.05
...
//  }
 noInterrupts();
 unsigned long input_THROTTLE = pulseIn(5, HIGH);
  //unsigned long Pitch = 30 + pulseIn(38, HIGH);
  //unsigned long Roll = 30 + pulseIn(36, HIGH);
